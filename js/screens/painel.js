...
function cardHTML(title, id, n0, n1, n2, categoria){
    return [
        ...
        +"    <li class=\"collection-item\"><div>CRITÉRIO 3<a href=\"#!\" class=\"secondary-content\">"+n1+"</a></div></li>"
        +"    <li class=\"collection-item\"><div>CRITÉRIO 2<a href=\"#!\" class=\"secondary-content\">"+n2+"</a></div></li>"
